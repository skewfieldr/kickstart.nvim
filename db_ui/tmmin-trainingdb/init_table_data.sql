-- Insert query for table istd.positions
INSERT INTO istd.positions (name, is_active, created_at, created_by, modified_at, modified_by )
VALUES 
...
-- Insert query for table istd.employees
INSERT INTO istd.employees (position_id , name , date_of_birth , joined_date , status , status_remarks , created_at , created_by , modified_at , modified_by)
VALUES
